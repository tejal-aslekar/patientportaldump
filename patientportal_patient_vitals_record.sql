...
DROP TABLE IF EXISTS `patient_vitals_record`;
...
LOCK TABLES `patient_vitals_record` WRITE;
/*!40000 ALTER TABLE `patient_vitals_record` DISABLE KEYS */;
/*!40000 ALTER TABLE `patient_vitals_record` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-11-10 21:44:46
